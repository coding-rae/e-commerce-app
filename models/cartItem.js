...
module.exports = class CartItemModel {
    ...
    static async find(cartId) {
        ...
        try{
            ...
            const statement = 'SELECT ci.qty, ci.id AS "cartItemId", p.* FROM 'cartItems' ci INNER JOIN products p ON p.id = ci."productId" WHERE "cartId" = $1'
            const values = [cartId];
